  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      ...
      SgissText(text: "Görüntü ve Ses Sistemleri Elemanı(2584)"),
        SgissText(text: "Seslendirme ve Işıklandırma Sistemleri Kurulum, Bakım ve Onarımcısı(542)"),
        SgissText(text: "Isı ve Ses Yalıtımcısı(840)"),
        SgissText(text: "Tehlikeli ve Çok Tehlikeli İşlerde Görüntü Ses Sistemleri(40)"),
      ]
